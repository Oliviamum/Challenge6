var questions = [
    ...
    {
        title: "What is the result of 3 + 2 + '7' in JavaScript?",
        choices: ["12", "327", "57", "NaN"],
        answer: "57"
    },
    {
        title: "Which method can be used to remove the last element from an array in JavaScript?",
    ...
    },
    {
        ...
        choices: ["'==' compares value and type, while '===' compares only type", "'==' compares only type, while '===' compares value and type", "'==' compares value only, while '===' compares value and type", "'==' and '===' are interchangeable"],
        answer: "'==' compares value only, while '===' compares value and type"
    },
    {
